...
if(isset($_POST['save_newVariety']))
{
    ...
    $check=mysqli_query($con,"select * from subcategorylist  where  category='$category' and  subcategory='$subcategory'");
    ...
    $query = "INSERT INTO subcategorylist (category,subcategory) VALUES ('$category','$subcategory')";
